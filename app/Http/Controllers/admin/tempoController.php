       ...
       if($tempos->isEmpty())
        {
         ...
         return view('admin.exports.addMore' , compact('product' , 'category','size','temp'));
       ...
       if($tempos->isEmpty())
        {
         ...
         $category = category::orderBy('id','desc')->get();
         $size = Size::orderBy('id','desc')->get();
         return view('admin.sales.addMore' , compact('product' , 'category','temp','size'));
       ...
       if($tempos->isEmpty())
        {
         ...
         $category = category::orderBy('id','desc')->get();
         $size = Size::orderBy('id','desc')->get();
         return view('admin.imports.addMore' , compact('product' , 'category','temp','size'));
    }
