...
<div class="page-content">
     <div class="row">
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              ...
              <div class="ibox-title">
                ...
                <h5>LAST PAYMENT FOR THE {{ $blck->name }}</h5>
              </div>
                    ...
                    <table id="example7" class="display nowrap table  responsive nowrap table-bordered">
                      <thead>
                       <tr>         <th>No. </th>
                                 ...
                                 <tbody>
                          @if($blckpay)
                         @foreach ( $blckpay as $index => $impos )
                                       <td>{{ $index+1 }}</td>
                                       <td>{{ $impos->Date }}</td>
                                       <td>{{ $blck->blockFee }}</td>
                                       <td> 
                                       ...
                                       <td>{{ $impos->Name }}</td>
                                       <td>
                 {{--    <a href="{{ URL::to('payout/' . $impos->id. '/edit')}}" class="btn btn-block btn-success"><i class="glyphicon glyphicon-edit" aria-hidden="true"></i>Edit Payment</a> </td> --}}
                    <a href="#" class="btn btn-block btn-success"><i class="glyphicon glyphicon-edit" aria-hidden="true"></i>Edit Payment</a> </td>
                                       </td>
                                    </tr>
                         @endforeach
                      @endif                
          ...
          <div class="widgets-container">
            <h3>ADD  PAYMENT FOR {{ $blck->name }} </h3>

     {!! Form::open(['method'=>'POST','route' => 'payout.store']) !!}  
             {!! Form::hidden('block_id', $blck->id, []) !!}
