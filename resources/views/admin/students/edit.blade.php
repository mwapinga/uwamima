...
@section('content')
  <!--== User Details ==-->
         ...
         @include('includes.Errors')
             {!! Form::model($bs, ['method'=>'PATCH','action'=> ['beststudentController@update' , $bs->id ],'files'=>true]) !!}
             {!! Form::hidden('id', $bs->id) !!}
               ...
               <div class="input-field col s12">
                ...
                {!! Form::file('photo_id', ['class'=>'required', 'multiple']) !!}
                  ...
                  <div class="file-path-wrapper">
                     ...
                     <br >  <br >  <br >
                   {!! Form::open(['method'=>'DELETE','action'=> ['beststudentController@destroy',$bs->id]]) !!}  
                    {!! Form::submit('Delete Student', ['class'=>'btn btn-danger col-sm-6']) !!}
                     {!! Form::close() !!}
                                </div>
                            </div>
                        </div>
