...
@section('content')
  <!--== User Details ==-->
         ...
         @include('includes.Errors')
             {!! Form::model($rep, ['method'=>'PATCH','route'=> ['rep.update' , $rep->id ],'files'=>true]) !!}
             {!! Form::hidden('id', $rep->id) !!}

            <div class="row" >
               <div class="input-field col s12">
                        {!! Form::label('name', 'Enter The descriptions ') !!}
                ...
                {!! Form::file('photo_id', ['class'=>'required', 'multiple']) !!}
                  ...
                  <div class="file-path-wrapper">
                     ...
                     <br >  <br >  <br >
                   {!! Form::open(['method'=>'DELETE','route'=> ['rep.destroy',$rep->id]]) !!}
                    {!! Form::submit('Delete Report', ['class'=>'btn btn-danger col-sm-6']) !!}
                     {!! Form::close() !!}
                                </div>
                            </div>
                        </div>
