...
@section('content')
  <!--== User Details ==-->
         ...
         {!! Form::model($test, ['method'=>'PATCH','route'=> ['testimonial.update' , $test->id ],'files'=>true]) !!}
            ...
            <div class="row" >
                <div class="input-field col s12">
                 ...
                 <div class="input-field col s12">
                          {!! Form::label('surname', 'Enter the Title') !!}
              ...
              {!! Form::select('status', [1=>'active',0=>'Not active'],0) !!}
                     ...
                     <br >  <br >  <br >
                   {!! Form::open(['method'=>'DELETE','route'=> ['testimonial.destroy',$test->id]]) !!}
