...
<body class="page-header-fixed ">
    <div class="page-header navbar navbar-fixed-top">
        ...
        <div class="page-header-inner ">
            <!-- BEGIN LOGO -->
            <div class="page-logo">
                <a href="{{ url('/sub') }}"> <img class="logo-default" alt="logo" src="{{ asset('assets/images/logo.png') }}"> </a>
            </div>
...
<!--  TOP NAVIGATION MENU -->
                <div class="hor-menu  hor-menu-light hidden-sm hidden-xs">
                    <ul class="nav navbar-nav">
                        <li class="mega-menu-dropdown mega-menu-full hover-initialized"> <a  href="{{ url('/sub') }}"><h3>UWAMIMA CONROL MANAGEMENT SYSTEM DASHBOARD</h3> </a>
                </div>
                <!--  TOP NAVIGATION MENU -->
                ...
                <ul class="nav navbar-nav pull-right">
                     ...
                     <li>
                        @if(Auth::user()->hasRole('Admin'))
                            <a href="{{ URL::to('uwadmin')}}" class="btn btn-info"><i aria-hidden="true"></i>SWITCH TO ADMIN</a> </td>
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            <li>
                            <a href="{{ URL::to('profile')}}""> <i class="icon-user"></i> My Profile </a>
        ...
        <div class="page-sidebar-wrapper">
            <div class="page-sidebar">
                <ul class="page-sidebar-menu  page-header-fixed ">
                    <br>
                    <li class="heading">
                        <h3 class="uppercase">Block Owner</h3>
                 </li>

                   <li class="nav-item">
                        <a class="nav-link nav-toggle" href="javascript:;"> <i class="fa fa-long-arrow-left"></i> <span class="title">Imports</span> <span class="arrow"></span> </a>
                <ul class="sub-menu">
                    <li class="nav-item"><a class="nav-link" href="{{ url('import') }}">My Imports</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ url('report') }}">Imports Reports</a></li>
                        </ul>
                    </li>
                   <li class="nav-item">
                        <a class="nav-link nav-toggle" href="javascript:;"> <i class="fa fa-long-arrow-right"></i> <span class="title"> Exports</span> <span class="arrow"></span> </a>
                        <ul class="sub-menu">
                     <li class="nav-item"><a class="nav-link" href="{{ url('export') }}">My Exports</a></li>
                     <li class="nav-item"><a class="nav-link" href="{{ url('report/create') }}">Exports Reports</a></li>
                        </ul>
                    </li>
                     <li class="nav-item">
                        <a class="nav-link nav-toggle" href="javascript:;"> <i class="fa fa-exchange"></i> <span class="title"> Sales</span> <span class="arrow"></span> </a>
                        <ul class="sub-menu">
                            <li class="nav-item"><a class="nav-link" href="{{ url('sales') }}">My Sales</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('/salerep') }}">Sales Reports</a></li>
                        </ul>
                    </li>
                      <li class="nav-item">
                        <a class="nav-link nav-toggle" href="javascript:;"> <i class="fa fa-align-center"></i> <span class="title"> Orders</span> <span class="arrow"></span> </a>
                        <ul class="sub-menu">
                            <li class="nav-item"><a class="nav-link" href="{{ url('order') }}">Oders</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('report/orders') }}">Oders Reports</a></li>
                        </ul>
                      </li>
                       <li class="nav-item">
                        <a class="nav-link nav-toggle" href="javascript:;"> <i class="fa fa-clone"></i> <span class="title"> Block</span> <span class="arrow"></span> </a>
                        <ul class="sub-menu">
                            <li class="nav-item"><a class="nav-link" href="{{ url('block') }}">My Blocks</a></li>
                        </ul>
                  </li>
